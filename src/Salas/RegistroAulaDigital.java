 ...
 * @author HP
 */
public class RegistroAulaDigital extends javax.swing.JFrame {
    ...
    public void AgrgarEventoAudiovisual() {
        ...
        try {
            ...
            pst.setString(3, String.valueOf('6'));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroAulaDigital.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroAulaDigital().setVisible(true);
            }
        });
    }
