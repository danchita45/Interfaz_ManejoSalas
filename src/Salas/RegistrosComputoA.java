 ...
 * @author HP
 */
public class RegistrosComputoA extends javax.swing.JFrame {
int e;
  conexionSQL cc = new conexionSQL();
    ...
    public void AgrgarEventoAudiovisual(){
        ...
        pst.setString(3,String.valueOf('7'));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrosComputoA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrosComputoA().setVisible(true);
            }
        });
    }
