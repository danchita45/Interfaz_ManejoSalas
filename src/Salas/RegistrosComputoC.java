 ...
 * @author HP
 */
public class RegistrosComputoC extends javax.swing.JFrame {
int e;
  conexionSQL cc = new conexionSQL();
    ...
    public void AgrgarEventoAudiovisual(){
        ...
        pst.setString(3,String.valueOf('9'));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrosComputoC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrosComputoC().setVisible(true);
            }
        });
    }
